...
const ViewProjects = () => {
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("Are you sure you want to mark this project as inactive?")) return;
    try {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="w-64 bg-gray-800 text-white p-6">
        ...
        <ul>
          <li className="mb-4 hover:bg-gray-700 p-2 rounded cursor-pointer" onClick={() => navigate('/pm/dashboard')}>
            Dashboard
          </li>
          <li className="mb-4 hover:bg-gray-700 p-2 rounded cursor-pointer" onClick={() => navigate('/pm/viewprojects')}>
            Projects
          </li>
      ...
      <div className="flex-1 p-6">
        ...
        {loading ? (
          ...
          <div className="bg-white p-6 rounded shadow">
            <h2 className="text-2xl font-bold text-indigo-700 mb-4">{selectedProject.projectName}</h2>
            ...
            <p className="text-gray-700 mb-4"><strong>Contract Type :</strong> {selectedProject.contractTypeName}</p>
            <p className="text-gray-700 mb-2"><strong>Phase:</strong    > {selectedProject.phaseName}</p>
                  ...
                  {projects
                    ...
                    .map((project) => (
                      <tr key={project.id} className="border-t hover:bg-gray-50">
                        ...
                        <td className="py-2 px-4">{project.phaseName}</td>
